...
public class TwitterClient extends BaseOAuth10Client<TwitterProfile> {
    static {
	System.out.println("org.pac4j.oauth.client.TwitterClient: ALA mod loaded.");
    }
    ...
    protected void internalInit() {
        ...
        this.service = new ProxyOAuth10aServiceImpl(api,
						    new OAuthConfig(this.key,
								    this.secret,
								    this.callbackUrl,
    ...
    //NOTE: you need to pass include_email=true to the twitter OAuth URL if you want to receive the user's email.
